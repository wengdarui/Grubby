...
projecttestlisturl=ReadConfig().get_testsrite('projecttestlisturl')
projectcaseurl=ReadConfig().get_testsrite('projectcaseurl')
suite=makesuite_by_testlist(projecttestlisturl,projectcaseurl)
